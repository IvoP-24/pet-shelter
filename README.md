...
make game2    Run with second save file
make game3    Run with third save file
...
./pet_shelter                                    # Just run the simulation
./pet_shelter game_data2.txt                     # Use specific save file
./pet_shelter game_data.txt emp_0 FEED 5        # Assign feeding task
